			...
			<div class="col-md-4 col-lg-4">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab-modules" data-toggle="tab">@lang('messages.modules')</a></li>
						<li><a href="#tab-custom-link" data-toggle="tab">@lang('messages.customLinks')</a></li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-custom-link">
							...
							{!! Form::open(['action' => '\Dwij\Laraadmin\Controllers\MenuController@store', 'id' => 'menu-custom-form']) !!}
								...
								<div class="form-group">
									<label for="name" style="font-weight:normal;">@lang('messages.label')</label>
									<input class="form-control" placeholder="@lang('messages.label')" name="name" type="text" value=""  data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="name" style="font-weight:normal;">Megjelenítendő név</label>
									<input class="form-control" placeholder="Menü neve" name="displayName" type="text" value=""  data-rule-minlength="1" required>
								</div>
								<div class="form-group">
									<label for="icon" style="font-weight:normal;">@lang('messages.icon')</label>
								...
								<input type="submit" class="btn btn-primary pull-right mr10" value="Menü hozzáadása">
							{!! Form::close() !!}
						</div>
					</div><!-- /.tab-content -->
				</div><!-- nav-tabs-custom -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">@lang('messages.editMenuItem')</h4>
			</div>
