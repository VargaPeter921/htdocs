...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">@lang('messages.resetPassword')</p>
            <form action="{{ url('/password/reset') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="@lang('messages.password')" name="password_confirmation"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                        <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('messages.resetPassword')</button>
                    </div><!-- /.col -->
                    <div class="col-xs-2">
                    </div><!-- /.col -->
                </div>
            ...
            <a href="{{ url('/login') }}">@lang('messages.login')</a><br>
