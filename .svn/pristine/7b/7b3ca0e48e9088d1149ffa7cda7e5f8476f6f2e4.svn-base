...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $termek->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Termeks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/termeks/'.$termek->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Termeks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.termeks.destroy', $termek->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/termeks') }}" data-toggle="tooltip" data-placement="right" title="Back to Termeks"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'cikkid')
						@la_display($module, 'cikkszam')
						@la_display($module, 'cikkszam2')
						@la_display($module, 'cikknev')
						@la_display($module, 'mennyiseg')
						@la_display($module, 'kshszam')
						@la_display($module, 'gyarto')
						@la_display($module, 'cikkcsoportkod')
						@la_display($module, 'cikkcsoportnev')
						@la_display($module, 'tipus')
						@la_display($module, 'beszerzesiallapot')
						@la_display($module, 'webigendatum')
						@la_display($module, 'webmegjel')
						@la_display($module, 'leiras')
						@la_display($module, 'tomeg')
						@la_display($module, 'gartipusid')
						@la_display($module, 'garido')
						@la_display($module, 'garidotipus')
						@la_display($module, 'garhely')
						@la_display($module, 'meret')
						@la_display($module, 'garhelytipus')
						@la_display($module, 'arlistapoz')
						@la_display($module, 'megj')
						@la_display($module, 'cikkfajta')
						@la_display($module, 'gycikkszam')
						@la_display($module, 'focsoportkod')
						@la_display($module, 'focsoportnev')
						@la_display($module, 'cikkjellnev')
						@la_display($module, 'ertmenny')
						@la_display($module, 'szigoru_szamadasu')
						@la_display($module, 'stockvalue')
