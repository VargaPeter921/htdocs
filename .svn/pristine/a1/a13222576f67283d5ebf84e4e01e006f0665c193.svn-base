...
<div id="page-content" class="profile2">
	<div class="bg-success clearfix">
		...
		<div class="col-md-3">
			...
			<div class="dats1"><i class="fa fa-clock-o"></i> Csatlakozott {{ date("M d, Y", strtotime($employee->date_hire)) }}</div>
		</div>
		<div class="col-md-4">
			<div class="teamview">
				<a class="face" data-toggle="tooltip" data-placement="top" title="{{ $employee->name }}"><img src="{{ asset('la-assets/img/user1-128x128.jpg') }}" alt=""><i class="status-online"></i></a>
			</div>
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		...
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-info" data-target="#tab-info"><i class="fa fa-bars"></i> Alap információk</a></li>
		<li class=""><a role="tab" data-toggle="tab" href="#tab-timeline" data-target="#tab-timeline"><i class="fa fa-clock-o"></i> Idővonal</a></li>
		@if($employee->id == Auth::user()->id || Entrust::hasRole("SUPER_ADMIN"))
			<li class=""><a role="tab" data-toggle="tab" href="#tab-account-settings" data-target="#tab-account-settings"><i class="fa fa-key"></i> Fiók beállítások</a></li>
		@endif
	</ul>
					...
					<div class="panel">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label for="password" class=" col-md-2">Jelszó</label>
								<div class=" col-md-10">
									<input type="password" name="password" value="" id="password" class="form-control" placeholder="Jelszó" autocomplete="off" required="required" data-rule-minlength="6" data-msg-minlength="Please enter at least 6 characters.">
								</div>
							</div>
							<div class="form-group">
								<label for="password_confirmation" class=" col-md-2">Jelszú újra</label>
								<div class=" col-md-10">
									<input type="password" name="password_confirmation" value="" id="password_confirmation" class="form-control" placeholder="Jelszó újra" autocomplete="off" required="required" data-rule-equalto="#password" data-msg-equalto="Please enter the same value again.">
								</div>
							</div>
						</div>
						<div class="panel-footer">
							<button type="submit" class="btn btn-primary"><span class="fa fa-check-circle"></span> Jelszó megváltoztatása</button>
						</div>
					</div>
				</form>
			</div>
