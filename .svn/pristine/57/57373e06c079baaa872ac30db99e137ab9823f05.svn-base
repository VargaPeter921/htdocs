    ...
    <body>
        <div class="container">
            <div class="content">
				...
				<p>{!! $message !!}</p>
				@if(Auth::guest())
					<a href="{{ url('/') }}">@lang('messages.homepage')</a> | 
					<a href="javascript:history.back()">@lang('messages.goBack')</a>
				@else
					<a href="{{ url(config('laraadmin.adminRoute')) }}">@lang('messages.dashboard')</a> | 
					<a href="javascript:history.back()">@lang('messages.goBack')</a>
				@endif
            </div>
        </div>
