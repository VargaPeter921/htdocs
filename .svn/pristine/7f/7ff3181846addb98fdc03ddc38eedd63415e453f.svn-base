...
class TermeksController extends Controller
{
	...
	public $listing_cols = ['id', 'cikkid', 'cikkszam', 'cikkszam2', 'cikknev', 'mennyiseg', 'kshszam', 'gyarto', 'cikkcsoportkod', 'cikkcsoportnev', 'tipus', 'beszerzesiallapot', 'webigendatum', 'webmegjel', 'leiras', 'tomeg', 'gartipusid', 'garido', 'garidotipus', 'garhely', 'meret', 'garhelytipus', 'arlistapoz', 'megj', 'cikkfajta', 'gycikkszam', 'focsoportkod', 'focsoportnev', 'cikkjellnev', 'ertmenny', 'szigoru_szamadasu', 'stockvalue', 'source'];
